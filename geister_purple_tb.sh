...
$CXX $BUILD_CXXFLAGS "${MPATH[@]}" -c geister_purple_tb.cpp -o geister_purple_tb.o
$CXX $BUILD_CXXFLAGS   geister_core.o geister_rank_triplet.o tablebase_io.o geister_purple_tb.o   "$SEEK_OBJ" "$ZSTD_STATIC_LIB"   -o geister_purple_tb
